...
if __name__ == "__main__":
    ...
    if kuka.motion_transport.connected:
        ...
        sequence_points_prm = load_all_points_csv(str(database_dir / "prm.csv"))
        sequence_points_astar = load_all_points_csv(str(database_dir / "Astar.csv"))


        kuka.move_sequence(
            points=sequence_points_prm,
            mode=3,
            vel=0.10
        )
        sleep(1)
